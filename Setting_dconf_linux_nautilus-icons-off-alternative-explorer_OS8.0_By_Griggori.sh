...
position='top'
dock-items=['liteusermanager.dockitem', 'gufw.dockitem', 'gparted.dockitem', 'org.gnome.baobab.dockitem', 'org.gnome.DiskUtility-1.dockitem', 'org.gnome.Nautilus.dockitem', 'caja.dockitem', 'Thunar.dockitem', 'nemo.dockitem', 'terminology.dockitem', 'org.gnome.Terminal.dockitem', 'lxterminal.dockitem', 'mate-about.dockitem', 'alacarte-made-48.dockitem', 'gnome-system-monitor.dockitem', 'htop.dockitem', 'synaptic.dockitem', 'xfce-display-settings.dockitem', 'org.gnome.Todo.dockitem', 'onboard.dockitem', 'onboard-settings.dockitem', 'libreoffice-startcenter.dockitem', 'exo-preferred-applications.dockitem', 'kodi.dockitem', 'budgie-desktop-settings.dockitem', 'cinnamon-settings.dockitem', 'unity-tweak-tool.dockitem', 'org.gnome.Totem.dockitem', 'com.github.wwmm.pulseeffects.dockitem', 'pavucontrol.dockitem', 'ca.desrt.dconf-editor.dockitem', 'budgie-plank-prefs.dockitem', 'gnome-ppp.dockitem', 'alacarte-made-18.dockitem', 'steam.dockitem', 'JB-mission-control-jdk8.dockitem', 'JB-jvisualvm-jdk8.dockitem', 'JB-policytool-jdk8.dockitem', 'JB-controlpanel-jdk8.dockitem', 'gnome-shell-extension-prefs.dockitem', 'obs.dockitem', 'firefox.dockitem']
unhide-delay=0
...
virtual-root='file:///home/griggorii/compton-master'
tree-view=true
root='file:///'

[org/gnome/gedit/plugins]
active-plugins=['findinfiles', 'externaltools', 'colorschemer', 'quickopen', 'docinfo', 'snippets', 'wordcompletion', 'synctex', 'quickhighlight', 'charmap', 'time', 'modelines', 'bracketcompletion', 'git', 'colorpicker', 'commander', 'spell', 'pythonconsole', 'translate', 'filebrowser', 'terminal']
...
[org/gnome/software]
first-run=false
check-timestamp=int64 1588172324
...
enable-hot-corners=true
favorite-apps=['xfce4-screenshooter.desktop', 'org.gnome.Screenshot.desktop', 'ubiquity.desktop', 'brave-browser.desktop', 'firefox.desktop', 'nemo.desktop', 'org.gnome.Nautilus.desktop', 'org.gnome.Software.desktop', 'gnome-control-center.desktop', 'libreoffice-startcenter.desktop', 'com.gexperts.Tilix.desktop', 'caja.desktop', 'pavucontrol.desktop', 'gnome-system-monitor.desktop', 'org.gnome.tweaks.desktop']
